...
var data = {
  ...
  results: [
    ...
    },
    {
      ...
      original_title: "야차",
      overview: "Nicknamed after a human-devouring spirit, the ruthless leader of an overseas black ops team takes up a dangerous mission in a city riddled with spies.",
      popularity: 1988.357,
...
var myData = data.results.map(function (value) {

  return `<div class="movie">

     <img src="${data.results.backdrop_path}">
     <div class="movie-info">
   <h3>${data.results.original_title}</h3>
   <span class="blue">${data.results.vote_average}</span>
     </div>
     <div class="overview">
